...
class TextureTest():
	def __init__(self, blocks):
		...
		self.blockModel = Entity(model='quad', parent=camera.ui, position=self.BLOCK_MODEL_POSITION, scale=self.BLOCK_MODEL_SCALE)
		self.blockModelDefault = Entity(model='quad', texture='model/textureTemplate.png', parent=camera.ui, position=self.BLOCK_MODEL_POSITION, scale=self.BLOCK_MODEL_SCALE)
